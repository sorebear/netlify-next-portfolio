...
const skillsData = [
  {
    ...
    details: {
      text: [
        'I primarily work on large scale websites using Drupal to power the CMS, NextJS to power the frontend, and GraphQL to bridge the two.',
      ],
      icons: {
        row1: [
          ...
          { icon: 'images/devicons/graphql.svg', iconAlt: 'mysql icon', iconKey: 'web-graphql' },
        ],
        row2: [
          { separator: 'and', iconKey: 'web-sep-3' },
          { icon: 'images/devicons/drupal.svg', iconAlt: 'drupal icon', iconKey: 'web-drupal' },
    ...
    works: [
      {
        ...
        company: 'Paramount',
        spinalName: 'cbs',
        image: 'images/work/cbs-website-cropped.png',
        liveLink: 'https://cbs.com/',
      },
      {
        ...
        liveLink: 'https://thrive-leadership.netlify.app',
    ...
    works: [
      {
        ...
        spinalName: 'etonline',
        image: 'images/work/etonline-cropped.png',
        liveLink: 'https://www.etonline.com',
      },
      {
        name: 'Inside Edition',
        company: 'Paramount',
        companyLink: 'https://www.paramount.com/',
        spinalName: 'inside-edition',
        image: 'images/work/inside-edition-cropped.png',
        liveLink: 'https://www.insideedition.com',
      },
      {
